...
<table>
    ...
    <tr>
        ...
        <td>=> {{<audio-text src="audio/lession-2/sentences/sorry_id_rather_not_say_that.mp3" text="Sorry. I'd rather not say that.">}}</td>
    </tr>
    <tr>
